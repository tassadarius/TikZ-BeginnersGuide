...
\begin{verbatim}
\usepackage{tikz}                  %% base package
\usetikzlibrary{tikz.positioning}  %% library
\end{verbatim}
\end{block}
...
%
\textbf{inline skeleton}
\begin{lstlisting}[
    language=TeX,
    backgroundcolor = \color{lightgray!38},
    xleftmargin = 0.5cm,
    basicstyle=\small
    ]
\begin{figure}
...
Useful resources and documentation for learning and looking up things

%
\begin{itemize}
    \item \href{https://texdoc.org/serve/tikz/0}{PDF manual}
    \item \href{https://tikz.dev/}{https://tikz.dev}
\end{itemize}
...
\begin{frame}
    ...
    Any questions before we start with the workshop?
